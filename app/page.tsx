...
import { CheckCircle, Smartphone, Users, Zap, Target, Star } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-slate-900 tracking-tight">Workout Wizz</span>
            </div>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-slate-600 leading-relaxed font-medium">
                  Real-time form analysis using computer vision. Perfect your workout technique with instant feedback,
                  designed specifically for students and fitness beginners.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" className="text-lg px-8 font-semibold" onClick={openDemoVideo}>
                  Watch Demo
                </Button>
              </div>
              ...
              <div className="flex flex-col items-center sm:items-start">
                <div className="text-sm text-slate-600 mb-2 font-medium">Coming soon to app stores</div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-white rounded-full px-4 py-2 shadow-lg whitespace-nowrap">
                    <span className="text-sm font-semibold text-slate-900">Real-time Form Analysis</span>
                  </div>
                </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">The Problem Students Face</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium">
              Most students want to exercise more but struggle with proper guidance and intimidating gym environments.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border border-slate-200 bg-white rounded-lg p-6 text-center space-y-4">
              ...
              <div className="text-slate-900 font-semibold">Want to exercise more but lack guidance</div>
            </div>
            <div className="border border-slate-200 bg-white rounded-lg p-6 text-center space-y-4">
              <div className="text-4xl font-black text-orange-600">64%</div>
              <div className="text-slate-900 font-semibold">Feel uncomfortable in campus gyms</div>
            </div>
            <div className="border border-slate-200 bg-white rounded-lg p-6 text-center space-y-4">
              <div className="text-4xl font-black text-yellow-600">78%</div>
              <div className="text-slate-900 font-semibold">Quit due to uncertainty about proper technique</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">How Workout Wizz Works</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium">
              Advanced computer vision technology analyzes your form in real-time and provides instant feedback.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Select from our library of beginner-friendly exercises",
                icon: Target,
              },
              {
                step: "2",
                title: "AI Detects Joints",
                description: "Computer vision identifies key body joints and positioning",
                icon: Smartphone,
              },
              {
                step: "3",
                title: "Analyze Angles",
                description: "Algorithm calculates angles between joints for proper form",
                icon: Zap,
              },
              {
                step: "4",
                title: "Get Feedback",
                description: "Receive instant visual and audio form corrections",
                icon: CheckCircle,
              },
            ].map((item, index) => (
              <div key={index} className="text-center space-y-4 border border-slate-200 bg-white rounded-lg p-6">
                <div className="relative">
      ...
      <section id="features" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium">
              Everything you need to build a consistent, effective workout routine from your dorm room.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Get instant feedback on your exercise form with computer vision technology",
                icon: Target,
                color: "from-blue-600 to-blue-700",
              },
              {
                title: "No Equipment Needed",
                description: "Perfect for dorm rooms and small spaces - bodyweight exercises only",
                icon: Smartphone,
                color: "from-green-600 to-green-700",
              },
              {
                title: "Social Features",
                description: "Connect with classmates, share progress, and workout together",
                icon: Users,
                color: "from-purple-600 to-purple-700",
              },
              {
                title: "Gamified Challenges",
                description: "Study break workouts and achievement systems to keep you motivated",
                icon: Star,
                color: "from-yellow-600 to-yellow-700",
              },
              {
                title: "Student-Friendly Pricing",
                description: "Affordable plans designed specifically for student budgets",
                icon: CheckCircle,
                color: "from-red-600 to-red-700",
              },
              {
                title: "Campus Integration",
                description: "Partner with university rec centers and fitness programs",
                icon: Zap,
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-green-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight">The Numbers Don't Lie</h2>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed font-medium">
              Students are ready for a fitness solution designed specifically for them.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              { number: "92%", label: "Own smartphones capable of running our app" },
              { number: "78%", label: "Report interest in fitness apps for students" },
              { number: "46%", label: "YoY growth in student fitness app spending" },
            ].map((stat, index) => (
              <div
                key={index}
                className="text-center space-y-2 border border-white/30 bg-white/10 backdrop-blur-sm rounded-lg p-6"
              >
                <div className="text-5xl md:text-6xl font-black text-white">{stat.number}</div>
              ...
              <CardContent className="p-8 space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="text-4xl font-black text-slate-900">
                    $0<span className="text-lg text-slate-600 font-medium">/month</span>
                  </div>
                </div>
            ...
            <Card className="border-2 border-blue-500 relative">
              ...
              <CardContent className="p-8 space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="text-4xl font-black text-slate-900">
                    $5<span className="text-lg text-slate-600 font-medium">/month</span>
                  </div>
                </div>
                <ul className="space-y-3">
                  {[
      ...
      <section className="py-16 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-medium">
            Join thousands of students who are already improving their workout form and building healthy habits with
            Workout Wizz.
          </p>
      ...
      <footer className="bg-slate-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-black text-white tracking-tight">Workout Wizz</span>
              </div>
              <p className="text-slate-400 leading-relaxed font-medium">
                Your personal AI-powered fitness trainer, designed specifically for students.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li>
                  <a href="#how-it-works" className="hover:text-white transition-colors font-medium">
                    How It Works
                  </a>
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li>
                  <a href="mailto:admin@workoutwizz.com" className="hover:text-white transition-colors font-medium">
                    Contact
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-slate-700 mt-8 pt-8 text-center text-slate-400">
            <p className="font-medium">&copy; 2025 Workout Wizz. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
